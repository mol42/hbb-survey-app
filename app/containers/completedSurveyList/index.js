...
class CompletedSurveyList extends Component {
      ...
      <Container style={{backgroundColor : "white"}}>
        ...
        <Content>
          <View style={styles.bg}>
            <FlatList
                data={this.props.survey.choiceOwner.all.choiceOwnerList}
...
export default connect(mapStateToProps, bindAction)(CompletedSurveyList);